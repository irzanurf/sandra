    ...
    <div class="modal fade reject" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="post" action="<?= base_url("verifikator/reject") ?>">
                    <input type="hidden" name="id" value="<?= $surat->id ?>">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="status" value="<?=((int)$surat->status)-1?>"
                            ...
                            class="btn btn-success">Kembalikan ke departemen</button>
    ...
    <div class="modal fade approval" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="post" action="<?= base_url("verifikator/approve") ?>">
                    <input type="hidden" name="id" value="<?= $surat->id ?>">
                    <div class="modal-body">
                        <div class="form-group">
                            <h3>Catatan</h3>
                            ...
                            <select class="form-control" name="alur" required="">
                                <option value="">Please Select</option>
                                <option value="1">Akademik & Kemahasiswaan</option>
                                <option value="2">Sumber Daya</option>
                            </select>
                        </div>
                    </div>
                    <div class="modal-footer">
