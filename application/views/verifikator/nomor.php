<div class="">
    ...
    <div class="text-center">
        <button type="button" data-toggle="modal" data-target=".nomor" class="btn btn-success">
            Beri Nomor Surat
        </button>
    </div>

    <div class="modal fade nomor" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="post" action="<?= base_url("verifikator/insert_nomor") ?>">
                    <input type="hidden" name="id" value="<?= $surat->id ?>">
                    <div class="modal-body">
                        <div class="form-group">
                            <h3>Nomor Surat</h3>
                            <textarea class="form-control" placeholder="Write here..." name="nomor"></textarea><br>
                        </div>
                    </div>
