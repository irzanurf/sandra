...
class Kadep extends CI_Controller {
    ...
    public function index(){
        redirect(base_url('kadep/daftar_total'));
    }
    ...
    public function daftar_total()
    {
        ...
        $dep = [
            "tb_surat.departemen"=>$this->session->userdata('id')
        ];
        $data['view'] = $this->M_Surat->get_surat($dep)->result();
        // print_r ($dep);
        $this->header();
        $this->load->view('kadep/daftar_surat', $data);
    ...
    public function review(){
        ...
        $this->header();
        $this->log();
        $this->load->view('kadep/review', $data);
        $this->load->view('layout/footer');
    }
    ...
    public function approve(){
        ...
        $round = $this->M_Log->get_round_log(array('id_surat'=>"$id",'next_user'=>1))->row()->round;
        $data_review = [
            "id_surat"=>$id,
            "role"=>1,
            "catatan"=>"$catatan",
    ...
    public function reject(){
        ...
        redirect(base_url('kadep/daftar_all'));
    }
