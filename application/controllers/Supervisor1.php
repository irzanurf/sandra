...
class Supervisor1 extends CI_Controller {
    ...
    public function index(){
        redirect(base_url('supervisor1/daftar_total'));
    }
    ...
    public function approve(){
        ...
        $round = $this->M_Log->get_round_log(array('id_surat'=>"$id",'next_user'=>3))->row()->round;
        $data_review = [
            "id_surat"=>$id,
            "role"=>3,
            "catatan"=>"$catatan",
